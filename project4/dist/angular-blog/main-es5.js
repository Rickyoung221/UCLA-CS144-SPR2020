...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./list/list.component */
    "./src/app/list/list.component.ts"); //import { BlogService } from './blog.service';
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterOutlet"], _list_list_component__WEBPACK_IMPORTED_MODULE_2__["ListComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _list_list_component__WEBPACK_IMPORTED_MODULE_6__["ListComponent"], _preview_preview_component__WEBPACK_IMPORTED_MODULE_8__["PreviewComponent"], _edit_edit_component__WEBPACK_IMPORTED_MODULE_7__["EditComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    var BlogService = /*#__PURE__*/function () {
      ...
      _createClass(BlogService, [{
        ...
        value: function fetchPosts(username) {
          ...
          var resp = fetch("/api/" + username).then(function (res) {
            return res.json();
          }).then(function (data) {
            var posts = [];

            for (var doc in data) {
              _this.maxPostid = Math.max(_this.maxPostid, data[doc].postid);
              var post = new Post();
        ...
        value: function getPost(username, postid) {
          ...
          var resp = fetch("/api/" + username + '/' + postid, {
            method: "GET"
          }).then(function (res) {
            ...
            console.log(data);
            console.log(_this2.parseData(data[0]));
            return _this2.parseData(data[0]);
          })["catch"](function (error) {
            console.error('Error:', error);
            return null;
          });
        ...
        value: function newPost(username, post) {
          ...
          var postid = this.maxPostid + 1;

          if (post.postid) {
            var _postid = post.postid;
          } else {
            var _postid2 = this.maxPostid + 1;

            post.postid = _postid2;
          }

          console.log("/api/" + username + '/' + postid);
          var res = fetch("/api/" + username + '/' + postid, {
            method: "POST",
            credentials: 'include',
            headers: {
            ...
            _this3.maxPostid = _this3.maxPostid + 1;
          })
          /*
          .then(data =>{
            let onepost: Post[];
        ...
        key: "showMaxid",
        value: function showMaxid() {
          return this.maxPostid;
        }
      }, {
        key: "updatePost",
        value: function updatePost(username, post) {
          var update = fetch("/api/" + username + '/' + post.postid, {
            headers: {
  ...
  function srcAppEditEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function EditComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditComponent_div_0_Template_input_ngModelChange_7_listener($event) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditComponent_div_0_Template_textarea_ngModelChange_13_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_0_Template_button_click_18_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditComponent_div_0_Template_button_click_20_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
      ...
      _createClass(EditComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            var postid = _this4.activatedRoute.snapshot.paramMap.get('id');

            _this4.post = _this4.blogService.getCurrentDraft();

            if (_this4.post && _this4.post.postid === Number(postid)) {
              console.log("match!");
            } else {
              console.log(Number(postid), "idid!");

              _this4.blogService.getPost(_this4.username, Number(postid)).then(function (res) {
                return _this4.post = res;
              });
            }
          });
        }
        ...
        value: function getPost() {
          ...
          this.blogService.getPost(this.username, this.post.postid).then(function (res) {
            return _this5.post = res;
          });
          ;
        }
      }, {
        ...
        value: function save() {
          ...
          this.blogService.fetchPosts(this.username).then(function (res) {
            ...
            for (var curpo in res) {
              if (Number(res[curpo].postid) === _this6.post.postid) {
                flag = 1;
              }
            }

            if (flag === 0) {
              _this6.blogService.newPost(_this6.username, _this6.post);
            } else {
              console.log("update post here.");

              _this6.blogService.updatePost(_this6.username, _this6.post);
            }
    ...
    EditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [[4, "ngIf"], [1, "column", "edit"], [1, "form-text"], ["for", "title"], ["type", "text", "onclick", "this.select()", "id", "title", "required", "", "name", "title", "placeholder", "Enter the title....", "autofocus", "", 1, "form-control", 3, "ngModel", "ngModelChange"], ["for", "Body"], ["id", "body", "required", "", "name", "body", "placeholder", "Enter the content....", 1, "form-control", 2, "height", "400px", 3, "ngModel", "ngModelChange"], [1, "btn-group", "btn-group-lg"], [3, "click"], [3, "routerLink"]],
  ...
  function srcAppListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ListComponent_li_5_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListComponent_li_5_Template_div_click_1_listener() {
    ...
    var ListComponent = /*#__PURE__*/function () {
      ...
      _createClass(ListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.getPost(); //this.router.paramMap.subscribe(() => {
        ...
        value: function getPost() {
          ...
          this.blogService.fetchPosts(this.username).then(function (res) {
            return _this8.posts = res;
          }); //.subscribe(posts => this.posts = posts);
        }
      }, {
        key: "onSelect",
        value: function onSelect(id) {
          var selectPost = this.posts[id];
        ...
        value: function newPost() {
          ...
          var postid = this.blogService.showMaxid() + 1;
          var curUsername = this.username;
          var ret = {
          ...
          console.log("list new post", ret.postid); //this.blogService.newPost(this.username, ret);

          this.blogService.setCurrentDraft(ret); //ret.observable.subscribe(
    ...
    ListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 1,
      consts: [["id", "parent", 1, "list-container"], [1, "column", "list"], [1, "posts", 2, "width", "50%"], [4, "ngFor", "ngForOf"], [3, "click"], [1, "blog-post", 3, "click"], [1, "post-title"]],
  ...
  function srcAppPreviewPreviewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function PreviewComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PreviewComponent_div_1_Template_button_click_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2);
    ...
    var PreviewComponent = /*#__PURE__*/function () {
      ...
      _createClass(PreviewComponent, [{
        ...
        value: function getPost() {
          var postid = this.activatedRoute.snapshot.paramMap.get('id');
          console.log(postid);
          this.post = this.blogService.getCurrentDraft(); // this.blogService.getPost(this.username, Number(postid)).then(res => {
          //   this.post = res;
    ...
    PreviewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[1, "preview-container"], [4, "ngIf"], [1, "column", "preview"], [3, "innerHTML"], ["type", "submit", 3, "click"]],
